...
<script type="text/javascript"> dangerouslySetInnerHTML={{__html=`var subscribersSiteId='432c6f20-4f04-4803-b082-7d773aa19edc';`}} </script>
<script type="text/javascript" src="https://cdn.subscribers.com/assets/subscribers.js"></script>
<script src={safePrefix("firebase-messaging-sw.js")} /> 
    </React.Fragment>
  ]);
};
